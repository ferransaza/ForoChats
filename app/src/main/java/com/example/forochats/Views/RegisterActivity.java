                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                String query = "http://192.168.1.39:9000/Application/registrar?name=" + username.getText().toString() + "&age=" + age.getText().toString() + "&dni=" + dni.getText().toString() + "&email=" + email.getText().toString() + "&password=" + password.getText().toString();
